...
5. `mart.city_mobility_daily` calculates a city-local-day median of `1 - current_speed_kph / free_flow_speed_kph` and publishes valid-sample coverage plus average source confidence.
